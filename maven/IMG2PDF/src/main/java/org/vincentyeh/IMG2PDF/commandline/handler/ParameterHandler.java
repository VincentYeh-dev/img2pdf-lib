...
import org.vincentyeh.IMG2PDF.commandline.handler.core.MissingParameterExceptionHandler;
import org.vincentyeh.IMG2PDF.commandline.handler.core.ResourceBundleHandler;
import org.vincentyeh.IMG2PDF.commandline.handler.core.TypeConversionExceptionHandler;
import org.vincentyeh.IMG2PDF.commandline.handler.core.UnmatchedArgumentExceptionHandler;
    ...
    private Handler<String, Exception> getHandler() {
        return new MissingParameterExceptionHandler(
                new TypeConversionExceptionHandler(
                        new UnmatchedArgumentExceptionHandler(null)));
    }
